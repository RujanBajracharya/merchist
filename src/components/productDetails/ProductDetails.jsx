...
export const ProductDetails = ({ id, singleProduct }) => {
    ...
    const [currentVariant, setCurrentVariant] = useState(singleProduct.variants[activeVariant])
    ...
    <div className='productDetails' key={id}>
        ...
        <div className="info">
            ...
            <div className="rating">
                <Rating value={singleProduct.averageRating} precision={0.5} size='small' readOnly className='rating-component'/>
